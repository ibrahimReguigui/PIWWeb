 ...
 */
final class Version20220414232004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE categories_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE category_id categories_id INT DEFAULT NULL');
